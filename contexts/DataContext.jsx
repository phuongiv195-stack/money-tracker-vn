...
// Configuration
const TRANSACTIONS_LIMIT = 500; // Limit for better coverage
...
export const DataProvider = ({ children }) => {
  ...
  // Tag suggestions - unique tags from all transactions
  ...
  const value = useMemo(() => ({
    ...
    activeAccounts, archivedAccounts, accountNames, groupedAccounts, accountBalances,
    ...
    payeeSuggestions, payeeToCategoryMap, tagSuggestions,
